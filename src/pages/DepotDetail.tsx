...
const DepotDetail = () => {
    ...
    const platformPmas = depot ? Array.from(new Set(depot.platforms.map(p => p.pmaCode).filter(Boolean))) as string[] : [];
                ...
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    <img
                        ...
                        onError={(e) => {
                            ...
                            (e.currentTarget as HTMLImageElement).src = "https://images.unsplash.com/photo-1542255734-6019a2e37e96?q=80&w=2670";
                        }}
                    />
                </div>
                        ...
                        {activeTab === "contracting" && (
                            <div>
                                ...
                                <div className="space-y-8">
                                    {depot.platforms.map((p) => (
                                        p.contractingOffices && p.contractingOffices.length > 0 && (
                                    ...
                                    {depot.platforms.every(p => !p.contractingOffices || p.contractingOffices.length === 0) && (
                                        <div className="p-8 text-center text-slate-500 italic">No contracting office data available for supported platforms.</div>
                                    )}
                                </div>
                            </div>
                        )}
